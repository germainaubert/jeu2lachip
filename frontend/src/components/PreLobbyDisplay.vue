  ...
  methods: {
    ...
    checkInteraction: function () {
      for (let element of this.interactiveElement) {
        this.handleInterraction(element.name, this.collision(element, this.chip))
      }
    },
    ...
    handleInterraction: function (element, flag) {
      switch (element) {
        case "emptyBowl":
          this.$store.state.createLobbyComp = flag;
          break;
        case "fullBowl":
          this.$store.state.joinLobbyComp = flag;
          break;
      }
    },
  },
